+function () {
    ...
    var dom_tips = `<div id="com_heiliuer_sdic_tip"
     style="">
    <style>
    ...
    $(document).keydown(function (e) {
        ...
        if (e.keyCode == ctrlKey || e.keyCode == cmdKey) {
            var key = selectText() || (currentMouse$dom && currentMouse$dom.text() || currentMouse$dom.attr("title")) || "";
